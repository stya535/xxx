...
#cl = LineClient()
cl = LineClient(authToken='EBOIZVjdqgtkfbe3B130.9q2iIcfJltjghJCvoSD1Wa.uzrp4ffxMeZ4BRTikVU4TikEvqtHLWkkhkipOPnmuLE=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

#ki = LineClient()
ki = LineClient(authToken='EBqrE9BykzeXxxYYyKz9.EOYcW0xngUInI+VLRYA+sq.jMRcm6ENSetasRooBr4cOm50LT7AfeJOPlTsAZQJ/6Q=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='EBEgz3xWuetKGCH0G35d.AmGDRgFE5yBdIVKXJYYlpq.ji8yr2fEU9r9ycG6t27wej4DeUG0LRUT5j0fsnnPvQo=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='EBgBkeK1W7N6UFjBVjWb.uX0SsiemH0c3zs3E2pMkMW.0QMoHncwvtqwEPX8FLVUpMClVPv0Cm9PdLWARCvIGXE=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#kb = LineClient()
kb = LineClient(authToken='EBAGLbajPUAxz38H1VA2.LdHhDSGdYYWJ+Ax6bPisWG.V+uyW+pTgiEX+caylrH5RfKBmZTq+gc1Q1g3Po+OZ6E=')
kb.log("Auth Token : " + str(kb.authToken))
channel4 = LineChannel(kb)
kb.log("Channel Access Token : " + str(channel4.channelAccessToken))

#kd = LineClient()
kd = LineClient(authToken='EBJ8ImTBCdDBXJGoG2r1.lPUNU+brdzI8JxFWeMWmOq.EaiAiGLLO7x1s+tB/TPMQIEV+BePrkON7+qCzEapSfQ=')
kd.log("Auth Token : " + str(kd.authToken))
channel5 = LineChannel(kd)
kd.log("Channel Access Token : " + str(channel5.channelAccessToken))

#sw = LineClient()
sw = LineClient(authToken='EBybu8BOCEfWvKNRUtue.L6pjSeXv5ChDibigwPl0VG.POrEjFa/LJ65Bj29iv4ss0UagVl5Mu92LPeryeYmHCY=')
...
wait = {
    ...
    "sticker":False,
    "selfbot":True,
    "mention":"SINI KAK GABUNG CHAT AJA BIAR RAME ..SP TAU DAPET JODOH HEHE😊",
    "Respontag":"🤖 SELFBOT-BY:SADIS 🤖",
    "welcome":"Selamat datang & semoga betah",
    "comment":"Like like & like by SELFBOT-BY:SADIS",
...
#UPDATE FOTO
               ...
               if msg.contentType == 1:
                   if msg._from in admin:
                       if mid in Setmain["SOLOfoto"]:
                            path = cl.downloadObjectMsg(msg_id)
                            del Setmain["SOLOfoto"][mid]
                            cl.updateProfilePicture(path)
                            cl.sendMessage(msg.to,"Foto berhasil dirubah")

               if msg.contentType == 1:
                 if msg._from in admin:
                        if Amid in Setmain["SOLOfoto"]:
                            path = ki.downloadObjectMsg(msg_id)
                            del Setmain["SOLOfoto"][Amid]
                            ki.updateProfilePicture(path)
                            ki.sendMessage(msg.to,"Foto berhasil dirubah")
                        elif Bmid in Setmain["SOLOfoto"]:
                            path = kk.downloadObjectMsg(msg_id)
                            del Setmain["SOLOfoto"][Bmid]
                            kk.updateProfilePicture(path)
                            kk.sendMessage(msg.to,"Foto berhasil dirubah")
                        elif Cmid in Setmain["SOLOfoto"]:
                            path = kc.downloadObjectMsg(msg_id)
                            del Setmain["SOLOfoto"][Cmid]
                            kc.updateProfilePicture(path)
                            kc.sendMessage(msg.to,"Foto berhasil dirubah")
                        elif Dmid in Setmain["SOLOfoto"]:
                            path = kb.downloadObjectMsg(msg_id)
                            del Setmain["SOLOfoto"][Dmid]
                            kb.updateProfilePicture(path)
                            kb.sendMessage(msg.to,"Foto berhasil dirubah")
                        elif Emid in Setmain["SOLOfoto"]:
                            path = kd.downloadObjectMsg(msg_id)
                            del Setmain["SOLOfoto"][Emid]
                            kd.updateProfilePicture(path)
                            kd.sendMessage(msg.to,"Foto berhasil dirubah")
                        elif Zmid in Setmain["SOLOfoto"]:
                            path = sw.downloadObjectMsg(msg_id)
                            del Setmain["SOLOfoto"][Zmid]
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention(msg.to, sender, "「 SELFBOT-BY:SADIS 」\n")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                Setmain["SOLOfoto"][mid] = True
                                cl.sendText(msg.to,"Kirim fotonya.....")
                                
                        elif cmd == "bot1up":
                            if msg._from in admin:
                                Setmain["SOLOfoto"][Amid] = True
                                ki.sendText(msg.to,"Kirim fotonya.....")
                                
                        elif cmd == "bot2up":
                            if msg._from in admin:
                                Setmain["SOLOfoto"][Bmid] = True
                                kk.sendText(msg.to,"Kirim fotonya.....")
                                
                        elif cmd == "bot3up":
                            if msg._from in admin:
                                Setmain["SOLOfoto"][Cmid] = True
                                kc.sendText(msg.to,"Kirim fotonya.....")
                                
                        elif cmd == "bot4up":
                            if msg._from in admin:
                                Setmain["SOLOfoto"][Dmid] = True
                                kb.sendText(msg.to,"Kirim fotonya.....")
                                
                        elif cmd == "bot5up":
                            if msg._from in admin:
                                Setmain["SOLOfoto"][Emid] = True
                                kd.sendText(msg.to,"Kirim fotonya.....")

                        elif cmd == "bot6up":
                            if msg._from in admin:
                                Setmain["SOLOfoto"][Zmid] = True
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"🤖 LIST admin\n\nSuper admin:\n"+ma+"\nAdmin:\n"+mb+"\nStaff:\n"+mc+"\nTotal「%s」SADIS" %(str(len(owner)+len(admin)+len(staff))))
...
#===========Hiburan============#
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                               ...
                               cl.sendMessage(msg.to,"SELFBOT-BY:SADIS1\n"+ki.authToken)
                               cl.sendMessage(msg.to,"SELFBOT-BY:SADIS 2\n"+kk.authToken)
                               cl.sendMessage(msg.to,"SELFBOT-BY:SADIS 3\n"+kc.authToken)
                               cl.sendMessage(msg.to,"SELFBOT-BY:SADIS 4\n"+kb.authToken)
                               cl.sendMessage(msg.to,"SELFBOT-BY:SADIS 5\n"+kd.authToken)
                               cl.sendMessage(msg.to,"SELFBOT-BY:SADIS 6\n"+sw.authToken)
#===========Protection============#
                          ...
                          if wait["selfbot"] == True:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     cl.sendMessage(msg.to, "🤖 SELFBOT-BY:SADIS 🤖 : %s" % str(group.name))
                                     group1 = ki.findGroupByTicket(ticket_id)
                                     ki.acceptGroupInvitationByTicket(group1.id,ticket_id)
                                     ki.sendMessage(msg.to, "🤖 SELFBOT-BY:SADIS 🤖 : %s" % str(group.name))
                                     group2 = kk.findGroupByTicket(ticket_id)
                                     kk.acceptGroupInvitationByTicket(group2.id,ticket_id)
                                     kk.sendMessage(msg.to, "🤖 SELFBOT-BY:SADIS 🤖 : %s" % str(group.name))
                                     group3 = kc.findGroupByTicket(ticket_id)
                                     kc.acceptGroupInvitationByTicket(group3.id,ticket_id)
                                     kc.sendMessage(msg.to, "🤖 SELFBOT-BY:SADIS 🤖 : %s" % str(group.name))
                                     group4 = kb.findGroupByTicket(ticket_id)
                                     kb.acceptGroupInvitationByTicket(group4.id,ticket_id)
                                     kb.sendMessage(msg.to, "🤖 SELFBOT-BY:SADIS 🤖 : %s" % str(group.name))
                                     group5 = kd.findGroupByTicket(ticket_id)
                                     kd.acceptGroupInvitationByTicket(group5.id,ticket_id)
                                     kd.sendMessage(msg.to, "🤖 SELFBOT-BY:SADIS 🤖 : %s" % str(group.name))
